...
set serverip=MYIPADDRESS
set serverport=MYPORT
...
%MYSQLExe% --user=%mysqlusr% --password=%mysqlpwd% --host=%mysqlhost% --port=%mysqlport% --database=%mysqldb% --execute="call pMain(%instanceid%)"
timeout /T 5
goto StartServer
